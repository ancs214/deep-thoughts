...
const resolvers = {
    Query: {
        ...
        me: async (parent, args, context) => {
           //if context.user property exists, find user
            if (context.user) {
             ...
             //if not context.user property exists, we know the user isnt authenticated
        ...
        thoughts: async (parent, { username }) => {
            ...
            //find thoughts by username and return in descending order
